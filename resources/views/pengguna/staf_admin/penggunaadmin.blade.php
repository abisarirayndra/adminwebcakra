            ...
            <div class="p-3 mt-3">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                            ...
                            <td>
                              <a href="{{ route('admin.penggunaadmin.lihat', [$item->id]) }}" class="btn btn-sm btn-success"><i class="fas fa-eye"></i></a>
                              <a href="{{ route('admin.penggunaadmin.hapus', [$item->id]) }}" onclick="return confirm('Anda yakin ingin menghapus akun ini ?')" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <form action="{{ route('admin.penggunaadmin.tambah') }}" method="POST">
                    @csrf
