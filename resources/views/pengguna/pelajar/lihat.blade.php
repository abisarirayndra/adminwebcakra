            ...
            <div class="p-3 mt-3">
                <div class="row">
                    ...
                    <div class="col-xl-8 col-sm-8">
                        ...
                        <div class="row">
                            <a href="{{ route('admin.penggunapelajar.editdata', [$pelajar->id]) }}" class="btn btn-success mt-4"><i class="fas fa-pen"></i> Edit Data</a>
                            <a href="{{ route('admin.penggunapelajar.suspend', [$pelajar->id]) }}" class="btn btn-warning mt-4 ml-3" onclick="return confirm('Anda yakin ingin suspend akun ini ?')"><i class="fas fa-ban"></i> Suspend</a>
                            <a href="{{ route('admin.penggunapelajar.hapus', [$pelajar->id]) }}" class="btn btn-danger mt-4 ml-3" onclick="return confirm('Anda yakin ingin menghapus akun ini ?')"><i class="fas fa-trash"></i> Hapus Data</a>
                        </div>
                    </div>
                </div>
            </div>
