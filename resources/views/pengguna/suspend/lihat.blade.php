            ...
            <div class="p-3 mt-3">
                <div class="row">
                    ...
                    <div class="col-xl-8 col-sm-8">
                        ...
                        <div class="row">
                            <a href="{{ route('admin.penggunasuspend.cabutsuspendpelajar', [$pelajar->id]) }}" class="btn btn-success mt-4" onclick="return confirm('Anda yakin ingin mencabut suspend akun ini ?')"><i class="fas fa-pen"></i> Cabut Suspend</a>
